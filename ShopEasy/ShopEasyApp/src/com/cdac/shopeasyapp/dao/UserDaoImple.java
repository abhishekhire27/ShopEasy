...
//				Transaction t = session.beginTransaction();
//				
//				SQLQuery q = session.createSQLQuery("Select * from Product where subCategoryId IN (Select subCategoryId from SubCategory where subCategoryName = ?)");
//				q.setString(0, subCategory);
//				
