...
<body>
	...
	<spr:form commandName="product" action="add_product.htm" class="form-horizontal">
		
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Product Name : <spr:input path="productName" type="text" class="form-control" style="width:500px" />
			</div>
		</div>
		
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Price : <spr:input path="price" type="text" class="form-control" style="width:500px" />
			</div>
		</div>
		
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Quantity Available : <spr:input path="quantityAvailable" type="text" class="form-control" style="width:500px" />
			</div>
		</div>
		
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Description : <spr:input path="description" type="text" class="form-control" style="width:500px" />
			</div>
		</div>
