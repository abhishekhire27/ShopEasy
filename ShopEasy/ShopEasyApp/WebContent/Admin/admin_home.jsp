	...
	<div style="height: 40px;">
		<nav class="navbar navbar-expand-sm bg-secondary" style="height: 40px">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item pl-4"><a class="nav-link" href="manage_product.htm"
					style="color: white">Manage Product</a></li>
				<li class="nav-item pl-4"><a class="nav-link" href="manage_subCategory.htm"
					style="color: white">Add SubCategory</a></li>
			</ul>
		</nav>
	</div>
	<!-- Slider -->
		...
		<div class="col-3 bg-white" style="margin-top: 20px">
			...
			<img class="pic-2"
				...
				<spr:form action="user_productlist.htm">
					<input type="submit" name="cat" value="Women" style="Color: Green" />
				</spr:form>
		</div>

		<div class="col-3 bg-White pl-4"
			...
			<img class="pic-2"
				...
				style="height: 200px; width: 300px; margin-top: 20px"> 
				<spr:form action="user_productlist.htm">
					<input type="submit" name="cat" value="Men" style="Color: Green" />
				</spr:form>
		</div>
	</div>
