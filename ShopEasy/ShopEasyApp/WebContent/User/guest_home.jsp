			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-5">
					<div class="d-flex justify-content-md-end justify-content-between">
						...
						<div>
							<a href="login.htm" class="login-btn"><i class="fa fa-sign-in"></i>							
								<span class="d-none d-md-inline-block">Sign In</span></a>
								
								<a href="register.htm" class="signup-btn"><i
	...
	<div class=" row bg-light" style="height: 300px">
		...
		<div class="col-3 bg-white" style="margin-top: 20px">
			...
			<img class="pic-2"
				...
				href="product_list.jsp" style="Color: Green">Women</a>
		</div>
		...
		<div class="col-3 bg-White pl-4"
			...
			<img class="pic-2"
				...
				style="height: 200px; width: 300px; margin-top: 20px"> <a
				href="product_list.jsp" style="Color: Green">Men</a>
		</div>
	</div>
