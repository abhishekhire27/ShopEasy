...
<body>
	...
	<div class="container-fluid">
		...
		<div class="headd " style="padding-top: 50px;">Select an
			delivery address</div>
		<div class="row" style="padding-top: 30px;">
			<div class="col-sm-3"></div>
			<div class="col-sm-6 box"
				style="font-family: cursive; padding-top: 10px;">
				<input type="radio" name="user-add" id="rd1" value="1" /> <label
					for="rd1">Registered Address</label><br /> <input type="radio"
					name="user-add" id="rd2" value="2" /> <label for="rd2">Add
					a new Address</label><br />
				<textarea rows="4" cols="50" placeholder="Add new address here..."></textarea>
				<br>
				<button type="submit" class="btn-middle rounded"
					style="margin-top: 20px; background-color: #05e2b6; color: white; border: none">
