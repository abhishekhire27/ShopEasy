...
<body>
	...
	<spr:form commandName="user" action="success_reg.htm" class="form-horizontal">
	
		<div class="form-group pl-4">
			<div class="col-sm-9">
				First Name : <spr:input path="userFirstName" id="fName" onblur="firstFun()" 
				placeholder="Enter your firstname" class="form-control" style="width:500px" required="true"  />
				<Span id="fSpan"></Span>
			</div>
		</div>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Last Name : <spr:input id="lName" onblur="lastFun()"   path="userLastName"  placeholder="Enter your lastname" class="form-control" style="width:500px" required="true" />
			<Span id="lSpan"></Span>
			</div>
		</div>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Email-ID : <spr:input id="emailId" onblur="emailIdValidation()" type="email" path="userEmail" required="true" 
				placeholder="Enter your email-Id" class="form-control" style="width:500px"/>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				User-ID : <spr:input onblur="ajaxcall()" id="userId" path="userId"   placeholder="Enter your user-Id" class="form-control" style="width:500px"  />
			</div>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Password : <spr:password path="userPassword" placeholder="Enter your password" id="pass" onblur="passwordFun()"
				 class="form-control" style="width:500px" required="true" />
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Phone NO : <spr:input  path="userPhone"  placeholder="Enter your phone no"  id="MbNum" onblur="mobNumberFun()" class="form-control" style="width:500px" required="true"  />
						<Span id="mSpan"></Span>
			</div>
		</div>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Address : <spr:input id="add" onblur="addFun()"  path="userAddress" type="text" placeholder="Enter your Address"  class="form-control" style="width:500px" required="true"  />
			<Span id="aSpan"></Span>
			</div>
		</div>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				<spr:input path="role" type="hidden" class="form-control" value="User" />
			</div>
		</div>
		
		<div class="form-group pl-4">
			<div class="col-sm-9">
				<spr:input path="userStatus" type="hidden" class="form-control" value="Inactive" />
			</div>
		</div>
		
		
		<input type="submit" id="Button" value="Register" class="btn btn-primary btn-block" style="width: 200px; margin-left: 130px">
