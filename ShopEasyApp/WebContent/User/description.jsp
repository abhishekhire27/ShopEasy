...
<body>
		...
		<nav class="navbar navbar-expand-sm bg-secondary" style="height: 40px">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item pl-4"><a class="nav-link"
					href="order_history.htm" style="color: white">ORDER HISTORY</a></li>
			</ul>
		</nav>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-4">
				<input type="image"
					src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSS8oEITt9vJtsCPRH0mvi2pRf8YZfN6YnkASdjsibLyayVVlidSUwG64QIWw" />
			</div>
			<div class="col-sm-5">

				<h1 class="pdp-title">HRX by Hrithik Roshan</h1>

				<h1 class="pdp-name pdp-bb1">Men Brown Printed Round Neck
					T-Shirt</h1>

				<div style="font-size: 24px; font-family: monospace;">RS.499</div>
				<div class="pdp-name pdp-bb1">Additional tax shall apply</div>

				<div style="font-size: 20px;">SELECT SIZE</div>
				...
				<button class="size-buttons">
					...
					<p class="size-buttons-unified-size">XLL</p>
				</button>


				<spr:form action="addcart.htm">
					<input type="submit" name="cat" value="Add to Cart"
						style="Color: Green" />
				</spr:form>
