						...
						<spr:form action="home.htm" commandName="user">
							<div class="form-group row">
								<label for="email_address"
									class="col-md-4 col-form-label text-md-right">User-Id:
								</label>
								<div class="col-md-6">
									<spr:input path="userId" type="text" class="form-control"
										requried="true" />
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<spr:password path="userPassword" class="form-control"
										required="true" />
								</div>
							</div>
							...
							<div class="col-md-6 offset-md-4">
								<input type="submit" value="Login" class="btn btn-primary" /> <a
									href="#" class="btn btn-link"> Forgot Your Password? </a>
							</div>
						</spr:form>
						<a href="register.htm" class="signup-btn">
						
						<i class="fa fa-user"></i><span class="d-none d-md-inline-block">Sign
								Up</span></a>
					</div>
