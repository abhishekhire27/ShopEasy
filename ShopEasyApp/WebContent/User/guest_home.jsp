			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-5">
					<div class="d-flex justify-content-md-end justify-content-between">
						...
						<div>
							<a href="login.htm" class="login-btn"><i
								class="fa fa-sign-in"></i> <span
								class="d-none d-md-inline-block">Sign In</span></a> <a
								href="register.htm" class="signup-btn"><i class="fa fa-user"></i><span
		...
		<div class="carousel-inner"
			...
			<div class="carousel-item active justify-content-center ">
				<img class="img-fluid max-width:50% height:auto"
					style="width: 100%; height: 500px;" src="images/image3.jpg"
					alt="First slide">
			</div>
			...
			<div class="carousel-item">
				<img class="d-block w-10" style="width: 100%; height: 500px;"
					src="images/image5.jpg" alt="Third slide">
			</div>
		</div>
	...
	<div class=" row bg-light" style="height: 300px">
		...
		<div class="col-3 bg-white" style="margin-top: 20px">
			...
			<img class="pic-2"
				...
				style="height: 200px; width: 300px; margin-top: 20px"> <a
				href="#" style="Color: Green">Women</a>
		</div>
