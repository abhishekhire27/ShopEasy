...
<script type="text/javascript">
	function getSubCat() {
		var a = document.getElementByID("abc").val;
		alert(a);
...
<body>
	...
	<spr:form commandName="product" action="add_product.htm"
		class="form-horizontal">

		<div class="form-group pl-4">
			<div class="col-sm-9">
				Product Name :
				<spr:input path="productName" type="text" class="form-control"
					style="width:500px" />
			</div>
		</div>
