...
<body>
	...
	<h2 class="pl-4 pt-4 pb-4">Add SubCategory</h2>

	<spr:form commandName="subCategory" action="add_subCategory.htm"
		class="form-horizontal">

		<div class="form-group pl-4">
			<div class="col-sm-9">
				SubCategory Name :
				<spr:input path="subCategoryName" type="text" class="form-control"
					style="width:500px" />
			</div>
		</div>
		...
		<div class="form-group pl-4">
			<div class="col-sm-9">
				Upload image :
				<spr:input path="image" type="file" class="form-control"
					accept="image/*" style="width:500px" />
			</div>
		</div>

		<div class="form-group pl-4">
			<div class="col-sm-9">
				<spr:input path="categoryId" type="hidden" value="1"
